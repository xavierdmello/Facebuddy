...
export default function Screenshot() {
  ...
  const captureScreenshot = async () => {
    ...
    try {
      ...
      setScreenshotUrl(`/api/screenshot-bezel?t=${newTimestamp}`);
    } catch (err) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4">Bezel Screenshot</h2>
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        >
          {loading ? "Capturing..." : "Capture Bezel Screenshot"}
        </button>
      </div>
        ...
        {screenshotUrl ? (
          <div className="relative w-full h-[500px]">
            <Image
              ...
              onError={() => {
                setError(
                  "Failed to load screenshot. Bezel app might not be running."
                );
